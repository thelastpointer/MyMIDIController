...
{
    /// <summary>
    /// Sets the main volume in Windows.
    /// Grabs specific COM objects to do this.
    /// </summary>
    /// <remarks>
    /// Source: https://eskerahn.dk/?p=2089
    /// </remarks>
    class VolumeSetter
    {
        ...
        public void Set(float value)
        {
            try
            {
                int res = aepv.SetMasterVolumeLevelScalar(value, ZeroGuid);
            }
            catch { }
        }

        IAudioEndpointVolume aepv;
